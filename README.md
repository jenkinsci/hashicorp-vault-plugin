[![Build Status](https://jenkins.ci.cloudbees.com/buildStatus/icon?job=plugins/hashicorp-vault-plugin)](https://jenkins.ci.cloudbees.com/job/plugins/job/hashicorp-vault-plugin)
